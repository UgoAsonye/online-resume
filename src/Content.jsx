              ...
              <div className="bg-white p-2">
                <div className="d-flex flex-row user-info">
                  ...
                  <div className="d-flex flex-column justify-content-start ml-2">
                    <span className="d-block font-weight-bold name">Maria Andrews</span>
                    <span className="date text-black-50">Shared publicly - Jan 2020</span>
                  </div>
                </div>
                <div className="mt-2">
                  <p className="comment-text">Looking for a software engineering job. Do you know where is hiring?</p>
                </div>
              </div>
